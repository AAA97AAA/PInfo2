...
\pagestyle{fancy}
\fancyhf{}
\lhead{\projectname \, Vision}
\rhead{\copyright\teamname, \the\year}
...
% \bigskip
\begin{longtable}{| N M{50pt} | ^ M{40pt} | ^ M{115pt} | ^ M{105pt} |}
	\caption{Revision History} \tabularnewline
	\hline
	...
	\hline
	20/03/2018 & 1.1 & Update formating & Nicolas \bsc{Cotte} \tabularnewline
	\hline
\end{longtable}
\end{abstract}
