...
function GrowlAdvancedSearchBar() {
    var x, text, y, z, a,b,c;
    a = document.getElementById("fromDate").value;
    b = document.getElementById("toDate").value;
    c = document.getElementById("author").value;
    x = document.getElementById("keyword").value;
    y = document.getElementById("myUL1").value;
    z = document.getElementById("myUL2").value;
