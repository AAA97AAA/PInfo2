...
app.controller('homeController', function($scope, $http){
  // DISPLAY THE TAGS + if click on TAG, search result for tag
	 ...
	 // we construct the url that we want to get
	  ...
	  var decoded = jwt_decode($scope.token);
...
/* Controller that gets the JWT of the current user, decode it, and get the id in the JSON obtained by deconding*/
app.controller('jwtDecoderController', function($scope, $http){
