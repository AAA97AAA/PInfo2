...
//	
//	@Mock
//	private ProfilePictureService fakeProfilePictureService;
//		
////	/**
...
//
//		// Calling new user service
//		UserService userServiceFake = new ConcreteUserService(fakeEntityManager);
//						
...
////		long id = ThreadLocalRandom.current().nextLong();
////		UserService userServiceFake = new ConcreteUserService(fakeEntityManager);
////		userServiceFake.modifyUser(id, fakeUser);
////		
////		when(userServiceFake.getUser(id)).thenReturn(fakeUser);
////		
////		// Verifying right method calls on objects in the service's function
...
////	 */
////	@Test
////	public void testModifyUserProfilePicture() {
////		
////		// Specifying behavior for mock objects related to calls in the service
////		when(fakeEntityManager.getCriteriaBuilder()).thenReturn(fakeCriteriaBuilder);		
...
////		long id = ThreadLocalRandom.current().nextLong();
////		UserService userServiceFake = new ConcreteUserService(fakeEntityManager);
////		userServiceFake.modifyUserProfilePicture(id, fakeDocument);
////		
////		when(userServiceFake.getUser(id)).thenReturn(fakeUser);
////
////		// Verifying right method calls on objects in the service's function
